...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5627fb3a03bb8a66fd4e5c2a59eb4def) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Type_def"; "Expr_helpers"; "Expr_simplifications"];
                      lib_pack = true;
                      lib_internal_modules = ["Expr_to_opcalc"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ocrs"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "4\006\162\028:\024\230H*\002\178\nm{K\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
