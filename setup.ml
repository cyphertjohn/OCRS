...
(* OASIS_START *)
(* DO NOT EDIT (digest: b484a2307da8f87ef97ec74ce7d46119) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Expr_def"; "Subscript_def"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\t\235\240\129\175ww\207\129\185\133\156A+\172\248";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
