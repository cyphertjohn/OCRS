...
(* OASIS_START *)
(* DO NOT EDIT (digest: 40fcdb31fde86c73688f54c1155065cc) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Type_def"; "Expr_helpers"];
                      lib_pack = true;
                      lib_internal_modules =
                        ["Expr_simplifications"; "Expr_to_opcalc"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\165_\213^$\001\bAQI\029T\153\190\163\196";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
