...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5a50479e0b6d1de3a22e5c312bc2f361) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/cyphertjohn/OCRS";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "A package based on Lothar Berg's operational calculus to solve recurrences"
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("gmp", None)];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation for OCRS";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\007\t\238\145x\160\1862\1667\233P\208\158\190\149";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
