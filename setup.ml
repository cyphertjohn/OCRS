...
(* OASIS_START *)
(* DO NOT EDIT (digest: 57729465e0db96950b48b5faf312a00c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Type_def"; "Solve_rec"; "Expr_helpers"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "b\159\171f\011&\026\182\003\165\016\026\177R\206\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
